...
public class UserAjout {
    ...
    private MessageAjout messageenv;

    @ManyToOne(cascade=CascadeType.PERSIST)
    @JoinColumn(name="idurecepteur",nullable=false)
    private MessageAjout messagerecep;*/

    public UserAjout() {
    }

    public UserAjout(Long idu, String nomu, String prenomu, String telu, String emailu, String adru, String typeu, Integer nbfollower, LocalDate dateinscri, String photou, String mdpu, String introu, String imgcouv) {
        this.idu = idu;
        this.nomu = nomu;
    ...
    public UserAjout(String nomu, String prenomu, String telu, String emailu, String adru, String typeu, Integer nbfollower, LocalDate dateinscri, String photou, String mdpu, String introu, String imgcouv) {
        this.nomu = nomu;
        this.prenomu = prenomu;
        this.telu = telu;
        this.emailu = emailu;
    ...
    /*public MessageAjout getMessageenv() {
        return messageenv;
    }

    public void setMessageenv(MessageAjout messageenv) {
        this.messageenv = messageenv;
    }

    public MessageAjout getMessagerecep() {
        return messagerecep;
    }

    public void setMessagerecep(MessageAjout messagerecep) {
